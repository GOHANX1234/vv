...
namespace c {
	...
	inline ImVec4 text_active = ImColor(180,180,180, 255);
    inline ImVec4 text_hov = ImColor(180,180,180, 200);
    inline ImVec4 text = ImColor(180,180,180, 200);

    ///////////////////////////////////////////// CHILD

    inline ImVec4 child_background = ImColor(15, 15, 15, 255);
    ...
    inline ImVec4 child_name = ImColor(127, 127, 127, 255);
	...
	inline ImVec4 accent_color = ImColor(4, 254, 7);
	inline ImVec4 accent_text_color = ImColor(255, 255, 255);
	inline ImVec4 circle_inactive = ImColor(255, 8, 4, 255);
