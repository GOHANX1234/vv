...
LOCAL_SRC_FILES := GHr_Ryuuka/Tools/curl/curl-android-$(TARGET_ARCH_ABI)/lib/libcurl.a
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS)

LOCAL_MODULE := libssl
LOCAL_SRC_FILES := GHr_Ryuuka/Tools/curl/openssl-android-$(TARGET_ARCH_ABI)/lib/libssl.a
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS)

LOCAL_MODULE := libcrypto
LOCAL_SRC_FILES := GHr_Ryuuka/Tools/curl/openssl-android-$(TARGET_ARCH_ABI)/lib/libcrypto.a
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS)
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/GHr_Ryuuka/Tools/curl/curl-android-$(TARGET_ARCH_ABI)/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/GHr_Ryuuka/Tools/curl/openssl-android-$(TARGET_ARCH_ABI)/include
...
FILE_LIST              += $(wildcard $(LOCAL_PATH)/GHr_Ryuuka/IL2CppSDKGenerator/*.c*)
FILE_LIST              += $(wildcard $(LOCAL_PATH)/*.c*)
FILE_LIST              += $(wildcard $(LOCAL_PATH)/GHr_Ryuuka/Tools/*.c*)
